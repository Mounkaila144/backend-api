...
use Modules\CustomersContracts\Http\Controllers\Superadmin\IndexController;
...
Route::prefix('api/superadmin')->middleware(['auth:sanctum'])->group(function () {
    Route::prefix('customerscontracts')->name('superadmin.customerscontracts.')->group(function () {
