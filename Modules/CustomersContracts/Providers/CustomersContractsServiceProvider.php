...
namespace Modules\CustomersContracts\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Facades\Config;

class CustomersContractsServiceProvider extends ServiceProvider
{
    /**
     * @var string Module name
     */
    protected $moduleName = 'CustomersContracts';

    /**
     * @var string Module name lowercase
     */
    protected $moduleNameLower = 'customerscontracts';
